    ...
    return (
      <div className="appc-header">
        ...
        <div className="appc-header__main">
          ...
          <Link className="appc-header__product-link" href="https://designer.appconnect.ibmcloud.com" target="_blank">Open App Connect&nbsp;&nbsp;<Icon name="icon--launch" fill="#fff" width="18" height="15"/></Link>
        </div>
      </div>
    )
  }
